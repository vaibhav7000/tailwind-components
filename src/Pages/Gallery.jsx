  ...
  const aspectRatio = [
    ...
    return (
        <div className="h-screen w-screen">
            <div className="flex h-full w-full flex-row flex-wrap gap-3">
                {images.map((image, index) => {
                    return (
                        <div key={index} className={`basis-[25.34%] ${aspectRatio[index]} self-start grow rounded-lg overflow-hidden`}>
